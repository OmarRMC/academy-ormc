...
export const catalog = [
...

  {
    ...
    sessions: [
      ...
      { id: 'sesion-09', n: 9, modulo: 'III', title: 'CRUD Profesional y Reportes', topics: ['Resource Controllers', 'CRUD completo', 'Mensajes Flash', 'Paginación', 'Exportación PDF', 'Exportación Excel'], status: 'disponible', descripcion: 'CRUD completo con resource controllers, paginación, mensajes flash y reportes en PDF y Excel.', order: 9, deckKey: 'laravel/Sesion09' },
      { id: 'sesion-10', n: 10, modulo: 'III', title: 'APIs RESTful', topics: ['API Routes', 'API Resources', 'Responses JSON', 'Resource Collections', 'Postman', 'Versionado'], status: 'disponible', descripcion: 'Construir y versionar APIs REST con API Resources y probarlas en Postman.', order: 10, deckKey: 'laravel/Sesion10' },
      { id: 'sesion-11', n: 11, modulo: 'III', title: 'Funcionalidades Avanzadas', topics: ['Correos', 'Colas/Queues', 'Jobs', 'Comandos Artisan', 'Scheduler'], status: 'disponible', descripcion: 'Correos por cola, jobs en segundo plano, comandos Artisan y tareas programadas con el scheduler.', order: 11, deckKey: 'laravel/Sesion11' },
      { id: 'sesion-12', n: 12, modulo: 'III', title: 'Despliegue en Producción', topics: ['Git', 'GitHub', 'Variables de entorno', 'Optimización', 'Caché', 'Seguridad', 'Hosting', 'Despliegue'], status: 'disponible', descripcion: 'Llevar la aplicación a producción: Git/GitHub, optimización, caché, seguridad y despliegue.', order: 12, deckKey: 'laravel/Sesion12' },
    ],
  },
]
